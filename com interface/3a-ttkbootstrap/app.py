...
class FormularioInscricao:
    def __init__(self, master):
        ...
        self.tema_var.set("darkly")  # Tema inicial
        ...
        # Botão Enviar
        self.enviar_btn = ttk.Button(self.botoes_frame, text="Enviar", bootstyle="success", command=self.enviar, width=20)
        self.enviar_btn.pack(side=LEFT, expand=True)

        # Botão Cancelar
        self.cancelar_btn = ttk.Button(self.botoes_frame, text="Cancelar", bootstyle="danger", command=self.cancelar, width=20)
    ...
    def enviar(self):
        # Atualiza o label com os dados coletados
